...
<div class="box">
    ...
    <form method="POST" action="<?php echo e(route('products.update', $product->id)); ?>" enctype="multipart/form-data">
        ...
        <input type="number" name="price" value="<?php echo e($product->price); ?>" placeholder="Price">
...
</html><?php /**PATH C:\Users\Shahbaz Computers\zenvora-store\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>